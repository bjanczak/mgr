...
\begin{titlepage}
	...
	\vspace{3\baselineskip}{\LARGE\strut inż. Bartłomiej Jańczak\par}
	...
	{\large prof. nzw. dr hab. Marzena Kryszkiewicz}
	\end{tabular}\par
    ...
    \par\noindent\vspace{1\baselineskip}
    \begin{tabular}[h]{l l}
    {\normalsize\it Data urodzenia:} & {\normalsize 3 marca 1988~r.}
    \end{tabular}
    \par\noindent\vspace{1\baselineskip}
    \begin{tabular}[h]{l l}
    {\normalsize\it Data rozpoczęcia studiów:} & {\normalsize 1 października 2011 r.}
    \end{tabular}
    \par\noindent\vspace{1\baselineskip}
    \end{flushleft}
    \end{minipage}
