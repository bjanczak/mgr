...
TimeReport TiDbscan::run(const Properties& properties, Dataset& dataset){
	...
	while(datasetIterators.size() > 0){
		...
		if(expandCluster(datasetIterators, datasetIteratorsIt, clusterId, TiDbscan::tiNeighborhood)){
...
list<list<vector<DbscanPoint>::iterator>::iterator> TiDbscan::tiNeighborhood(list<vector<DbscanPoint>::iterator>& setOfPoints, list<vector<DbscanPoint>::iterator>::iterator pointIt, const double eps){

	list<list<vector<DbscanPoint>::iterator>::iterator> forwardNeighborhood = TiDbscan::tiForwardNeighborhood(setOfPoints, pointIt, eps);
	list<list<vector<DbscanPoint>::iterator>::iterator> backwardNeighborhood = TiDbscan::tiBackwardNeighborhood(setOfPoints, pointIt, eps);
...
list<list<vector<DbscanPoint>::iterator>::iterator> TiDbscan::tiBackwardNeighborhood(list<vector<DbscanPoint>::iterator>& setOfPoints, list<vector<DbscanPoint>::iterator>::iterator pointIt, const double eps){
...
list<list<vector<DbscanPoint>::iterator>::iterator> TiDbscan::tiForwardNeighborhood(list<vector<DbscanPoint>::iterator>& setOfPoints, list<vector<DbscanPoint>::iterator>::iterator pointIt, const double eps){
