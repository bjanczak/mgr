...
bool TiDbscanBase::expandCluster(list<vector<DbscanPoint>::iterator>& dataset, list<vector<DbscanPoint>::iterator>::iterator& pointIt, unsigned int clusterId, neighborhoodFunction *neighborhood){
	...
	list<vector<DbscanPoint>::iterator>::iterator borderIt;
	list<vector<DbscanPoint>::iterator>::iterator borderEnd;
